...
class Mailer {
    ...
    protected $_ci;
  /*  protected $email_pengirim = $email; // Isikan dengan email pengirim
    protected $nama_pengirim = $kirim; // Isikan dengan nama pengirim
    protected $password = $pass; // Isikan dengan password email pengirim
*/
    ...
    public function send($data,$email_pengirim,$nama_pengirim,$password){
        $mail = new PHPMailer;
        $mail->isSMTP();
    ...
    public function send_with_attachment($data,$email_pengirim,$nama_pengirim,$password){
        $mail = new PHPMailer;
        $mail->isSMTP();
        ...
        if($data['attachment']['size'] <= 25000000){ // Jika ukuran file <= 25 MB (25.000.000 bytes)
            ...
            $response = array('status'=> FALSE, 'message'=>'Ukuran file attachment maksimal 25 MB');
        }
