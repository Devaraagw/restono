   ...
   <div class="w-1/5 bg-teal-700 text-white min-h-screen p-4">
    ...
    <nav>
     <ul> 
      ...
      <li class="mb-4"><a class="flex items-center p-2 bg-teal-600 rounded" href="<?= base_url('admin/konfirmasi') ?>">
    ...
    <table class="min-w-full bg-white border border-gray-300">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-4 border-b">Id_Konfirmasi</th>
                    <th class="py-2 px-4 border-b">Id_Pelanggan</th>
                    <th class="py-2 px-4 border-b">Jumlah Transfer</th>
                    <th class="py-2 px-4 border-b">Bukti Bayar</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="py-2 px-4 border-b text-center">1</td>
                    <td class="py-2 px-4 border-b text-center">3000000</td>
                    <td class="py-2 px-4 border-b text-center">0f562609e78d953de0fc403c5b185342.jpg</td>
                    <td class="py-2 px-4 border-b text-center">Y</td>
                    <td class="py-2 px-4 border-b text-center">
                        <button class="bg-green-500 text-white px-3 py-1 rounded">konfirmasi</button>
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 border-b text-center">1</td>
                    <td class="py-2 px-4 border-b text-center">3000000</td>
                    <td class="py-2 px-4 border-b text-center">cute-anime-wallpaper-high-definition-For-desktop-Wallpaper.jpg</td>
                    <td class="py-2 px-4 border-b text-center">Y</td>
                    <td class="py-2 px-4 border-b text-center">
                        <button class="bg-green-500 text-white px-3 py-1 rounded">konfirmasi</button>
                        <button class="bg-red-500 text-white px-3 py-1 rounded">Hapus</button>
