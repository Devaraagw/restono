        ...
        <div class="container">
            ...
            <section class="rooms-section">
                <div class="row room-section-header-container">
                    <div class="col col-3">
                        <h4 class="room-section-header" id="lantai1">Lantai 1</h4>
                    </div>
                    <div class="col col-3">
                        <h4 class="room-section-header" id="lantai2">Lantai 2</h4>
                    </div>
                </div>
                <div class="row center-lg" id="lantai1-rooms">
                    ...
                    <div class="row center-lg" id="lantai2-rooms" style="display: none;">
                    <div class="rooms col col-2">
